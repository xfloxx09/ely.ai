...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "100 Model Nexus requests / month (GPT, Claude, Gemini)",
      "Trait-modulated voice on replies",
  ...
  },
  {
    ...
    features: [
      ...
      "Ready Player Me avatar + evolution stages",
      "BYOK Model Nexus (OpenAI, Anthropic, Google) or Ely Credits",
      "Unilevel L1–L3 + leadership match commissions",
